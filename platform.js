...
var brick = new Image();
brick.src =
'data:image/png;base64,';
...
exports.draw = function(){
	...
	for (var y = 0; y < map.length; y++){
		for (var x = 0; x < map[0].length; x++)
			if (map[y][x]=='1') context.drawImage(brick, x*size, y*size);
